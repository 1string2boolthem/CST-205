...
def initializeRooms(): #This sets up the rooms initially.
  ...
  kitchen.addObject(Object("Refrigerator", "A large stainless steel refrigerator.", true))
  bedroom.setDirection("South", library)
  bedroom.addObject(Object("Bed", "A large bed covered by a plush comforter.", true))
  ...
  bathroom.addObject(Object("Toilet", "A spotless toilet. While it looks clean.", true))
